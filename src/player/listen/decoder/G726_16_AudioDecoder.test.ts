...
const LegacyCtor = loadLegacyModule<new () => LegacyG726Decoder>(
  'Listen/Decoder/audioDecoderG726_16.js',
...
describe('G726_16_AudioDecoder parity with the legacy player’s Listen/Decoder/audioDecoderG726_16.js', () => {
  it('decodes an identical Int16Array for the same input, evolving state the same way', () => {
    const legacy = new LegacyCtor();
    const ported = new G726_16_AudioDecoder();
